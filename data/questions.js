...
const shortSellingQuestionsFOUR = `
...
const shortSellingQuestionsFIVE = `
...
const shortSellingQuestionsSIX = `
...
`
const shortSellingQuestionsSEVEN = `
...
const shortSellingQuestionsEIGHT = `
...
const shortSellingQuestionsNINE = `
...
`
const shortSellingQuestionsTEN = `
...
`
const shortSellingQuestionsELEVEN = `
...
module.exports = {
    ...
    shortSellingQuestionsTWO,
    shortSellingQuestionsTHREE,
    shortSellingQuestionsFOUR,
    shortSellingQuestionsFIVE,
    shortSellingQuestionsSIX, shortSellingQuestionsSEVEN, shortSellingQuestionsEIGHT, shortSellingQuestionsNINE, shortSellingQuestionsTEN, shortSellingQuestionsELEVEN,
    GeneralQuestions,
    PivotQuestions
};